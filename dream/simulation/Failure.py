            ...
            # if time to failure counts only in onShift time
                ...
                while failureNotTriggered:
                    ...
                    if self.victimOffShift in receivedEvent:
                        assert self.victim.onShift is False, "shiftFailure cannot recalculate TTF if the victim is onShift"
                        ...
                        assert self.victim.onShift is True, "the victim of shiftFailure must be onShift to continue counting the TTF"
                    else:
